...
// Twitter Title
export const META_BASIC_TWITTER_TITLE = 'Browse Monash Unit Reviews | MonSTAR';
...
// * Unit overview ------------------------------------------------------------|
// Title
export const getMetaUnitOverviewTitle = (
  unitCode: string,
  unitName: string
): string => `${unitCode} (${unitName}) Student Reviews at Monash University`;

// Description
export const getMetaUnitOverviewDescription = (
  reviewCount: number,
  unitCode: string,
  unitName: string
): string =>
...
// Keywords
export const getMetaUnitOverviewKeywords = (
  unitCode: string,
  unitName: string
): string =>
...
// Open Graph Title
export const getMetaUnitOverviewOpenGraphTitle = (
  unitCode: string,
  unitName: string
): string => `${unitCode} - ${unitName} | Student Reviews`;
// Open Graph Description
...
// Twitter Description
export const getMetaUnitOverviewTwitterDescription = (
  unitCode: string,
  unitName: string,
  averageRating: number
): string =>
...
// Description
export const getMetaSetuOverviewDescription = (
  unitCode: string,
  seasonYear?: string
): string =>
...
// Open Graph Description
export const getMetaSetuOverviewOpenGraphDescription = (
  unitCode: string,
...
// Twitter Description
export const getMetaSetuOverviewTwitterDescription = (
  unitCode: string,
  aggregateScore?: number
): string =>
